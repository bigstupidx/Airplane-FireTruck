...
public class SteeringWheel : MonoBehaviour
{
    ...
    public void DragEvent(BaseEventData eventData)
    {
		...
		if (Vector2.Distance(pointerPos, centerPoint) > 20f  && Vector2.Distance(pointerPos, centerPoint) < 220f)
        {
		...
		// test
		//transform.Find("Image").GetComponent<Image>().color = new Color(1,1,1,0.75f);
    }
    ...
    public void ReleaseEvent(BaseEventData eventData)
    {
		...
		// test
		//transform.Find("Image").GetComponent<Image>().color = new Color(1,1,1,1);
