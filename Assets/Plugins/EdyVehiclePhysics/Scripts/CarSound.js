...
if (PlayerPrefs.GetInt("SFX") == 0)
	{
		...
		EngineExtraAudio.mute = true;
		TransmissionAudio.mute = true;
		VelocityAudio.mute = true;
		SkidAudio.mute = true;
		OffroadAudio.mute = true;
		BodyDragAudio.mute = true;
		BodyDragOffroadAudio.mute = true;
	}
}
