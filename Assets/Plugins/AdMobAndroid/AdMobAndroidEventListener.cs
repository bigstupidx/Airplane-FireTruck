...
public class AdMobAndroidEventListener : MonoBehaviour
{
    ...
    void Start()
    {
		...
		AdMobAndroid.createBanner("ca-app-pub-9255742339770963/2364898699", AdMobAndroidAd.smartBanner, AdMobAdPlacement.TopCenter);
        Instance = this;
    }
    ...
    public void Request()
    {
        if (!_requested)
        {
			AdMobAndroid.requestInterstital("ca-app-pub-9255742339770963/3841631899");
            _requested = true;
        }
    }
